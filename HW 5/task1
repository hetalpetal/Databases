...
SELECT cust_name FROM restBill WHERE surname = 'Smith';
SELECT cust_name FROM restBill WHERE surname LIKE "C";
SELECT first_name, surname FROM restStaff WHERE headwaiter='1';
SELECT * FROM restBill WHERE bill_date='february 2016';
SELECT bill_date FROM restBill WHERE bill_date='2015' ORDER BY bill_date ASC;
